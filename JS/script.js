...
// Lesson 9 List Filter

var srchInp9 = document.getElementById("srchInp9");
var nameList9 = document.getElementById("nameList9");
var li9 = document.getElementById("nameList9").getElementsByTagName("li");
var a9 = document.getElementById("nameList9").getElementsByTagName("a");

srchInp9.addEventListener("input", search9);

function search9() {
    var srchText9 = srchInp9.value.toUpperCase();
    for (let i = 0; i < a9.length; i++) {
        if (a9[i].innerHTML.toUpperCase().indexOf(srchText9) > -1) {
            li9[i].style.display = "";
        }
        else {
            li9[i].style.display = "none";
        }
    }
}
...
document.getElementById("plus10").addEventListener("click", func_plus10);
document.getElementById("minus10").addEventListener("click", func_minus10);
document.getElementById("divide10").addEventListener("click", func_divide10);
document.getElementById("multiply10").addEventListener("click", func_multiply10);

function func_plus10() {
    var num1_10 = parseInt(document.getElementById("num1_10").value);
    var num2_10 = parseInt(document.getElementById("num2_10").value);
    document.getElementById("result10").innerHTML = num1_10 + num2_10;
}

function func_minus10() {
    var num1_10 = parseInt(document.getElementById("num1_10").value);
    var num2_10 = parseInt(document.getElementById("num2_10").value);
    document.getElementById("result10").innerHTML = num1_10 - num2_10;
}

function func_multiply10() {
    var num1_10 = parseInt(document.getElementById("num1_10").value);
    var num2_10 = parseInt(document.getElementById("num2_10").value);
    document.getElementById("result10").innerHTML = num1_10 * num2_10;
}

function func_divide10() {
    var num1_10 = parseInt(document.getElementById("num1_10").value);
    var num2_10 = parseInt(document.getElementById("num2_10").value);
    document.getElementById("result10").innerHTML = num1_10 / num2_10;
}
